...
namespace V5Fred
{
    public class V5FredDbContext : DbContext, IV5FredDbContext
    {
        public V5FredDbContext()
        {
        }

        public V5FredDbContext(DbContextOptions<V5FredDbContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer(@"Data Source=(local);Initial Catalog=fred;Integrated Security=True;Application Name=EntityFramework Reverse POCO Generator", x => x.UseNetTopologySuite());
            }
        }
