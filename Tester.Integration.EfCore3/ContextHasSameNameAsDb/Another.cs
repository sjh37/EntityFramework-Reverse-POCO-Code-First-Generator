...
{
    public class Another : DbContext, IAnother
    {
        public Another()
        {
        }

        public Another(DbContextOptions<Another> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer(@"Data Source=(local);Initial Catalog=Fred;Integrated Security=True;MultipleActiveResultSets=True");
            }
        }
