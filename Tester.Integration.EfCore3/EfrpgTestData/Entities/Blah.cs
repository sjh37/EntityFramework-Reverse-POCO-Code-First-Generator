...
namespace Tester.Integration.EfCore3
{
    ...
    public class Blah
    {
        ...
        /// </summary>
        public ICollection<BlahBlahLink> BlahBlahLinks_BlahId { get; set; } // BlahBlahLink.FK_BlahBlahLink_Blah

        /// <summary>
        /// Child BlahBlahLinks where [BlahBlahLink].[BlahID2] point to this entity (FK_BlahBlahLink_Blah2)
        /// </summary>
        public ICollection<BlahBlahLink> BlahBlahLinks_BlahId2 { get; set; } // BlahBlahLink.FK_BlahBlahLink_Blah2

        /// <summary>
        /// Child BlahBlahLinkReadonlies where [BlahBlahLink_readonly].[BlahID] point to this entity (FK_BlahBlahLink_Blah_ro)
        /// </summary>
        public ICollection<BlahBlahLinkReadonly> BlahBlahLinkReadonlies_BlahId { get; set; } // BlahBlahLink_readonly.FK_BlahBlahLink_Blah_ro

        /// <summary>
        /// Child BlahBlahLinkReadonlies where [BlahBlahLink_readonly].[BlahID2] point to this entity (FK_BlahBlahLink_Blah_ro2)
        /// </summary>
        public ICollection<BlahBlahLinkReadonly> BlahBlahLinkReadonlies_BlahId2 { get; set; } // BlahBlahLink_readonly.FK_BlahBlahLink_Blah_ro2
        ...
        /// </summary>
        public ICollection<BlahBlargLink> BlahBlargLinks { get; set; } // BlahBlargLink.FK_BlahBlargLink_Blah
