...
namespace Efrpg.V3TestE8c
{
    ...
    public class EfrpgTestDbContext : DbContext, IEfrpgTestDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<FFRS_CvDataReturnModel>().Property(e => e.CVName).IsRequired(false);
            modelBuilder.Entity<FFRS_DataFromDboReturnModel>().HasNoKey();
            modelBuilder.Entity<FFRS_DataFromDboAndFfrsReturnModel>().HasNoKey();
            modelBuilder.Entity<FFRS_DataFromDboAndFfrsReturnModel>().Property(e => e.CVName).IsRequired(false);
    ...
    public class FakeEfrpgTestDbContext : IEfrpgTestDbContext
    {
        ...
        public DbSet<TEntity> Set<TEntity>() where TEntity : class
        {
            ...
            if (property == null)
                throw new InvalidOperationException("Cannot find a DbSet<" + typeof(TEntity).Name + "> on FakeEfrpgTestDbContext. The entity type is not part of this context.");
    ...
    public class InvoiceConfiguration : IEntityTypeConfiguration<Invoice>
    {
        public void Configure(EntityTypeBuilder<Invoice> builder)
        {
            ...
            builder.OwnsOne(x => x.TotalAmount, b =>
            {
                ...
                b.Property(x => x.Currency).HasColumnName(@"TotalAmount_Currency").HasColumnType("char(3)").IsRequired().IsFixedLength().IsUnicode(false).HasMaxLength(3);
            });
        }
    }
