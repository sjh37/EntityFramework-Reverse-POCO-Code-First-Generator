...
namespace Efrpg.V3TestE2
{
    ...
    public class EfrpgTestDbContext : DbContext, IEfrpgTestDbContext
    {
        ...
        public int ColumnNameAndTypesProc()
        {
            ...
            Database.ExecuteSqlCommand("EXEC @procResult = [dbo].[ColumnNameAndTypesProc] ", procResultParam);
        ...
        public int SpatialTypesNoParams()
        {
            ...
            Database.ExecuteSqlCommand("EXEC @procResult = [dbo].[SpatialTypesNoParams] ", procResultParam);
        ...
        public int SpatialTypesWithParams(NetTopologySuite.Geometries.Geometry geometry, NetTopologySuite.Geometries.Point geography)
        {
            ...
            Database.ExecuteSqlCommand("EXEC @procResult = [dbo].[SpatialTypesWithParams] @geometry, @geography", geometryParam, geographyParam, procResultParam);
        ...
        public int ThisHasMixedOutParameters(DateTime? foo, out int? firstOutParam, DateTime? bar, out int? secondOutParam, DateTime? baz = null)
        {
            ...
            Database.ExecuteSqlCommand("EXEC @procResult = [dbo].[ThisHasMixedOutParameters] @Foo, @FirstOutParam OUTPUT, @Bar, @SecondOutParam OUTPUT, @Baz", fooParam, firstOutParamParam, barParam, secondOutParamParam, bazParam, procResultParam);
        ...
        {
            return Query<C182Test1ReturnModel>()
                .FromSql("SELECT * FROM [dbo].[182_test1]({0})", test)
                .AsNoTracking();
        }
        ...
        {
            return Query<FFRS_CsvToInt2ReturnModel>()
                .FromSql("SELECT * FROM [FFRS].[CsvToInt2]({0}, {1})", array, array2)
                .AsNoTracking();
        }
    ...
    public class FakeDbSet<TEntity> : DbSet<TEntity>, IQueryable<TEntity>, IListSource where TEntity : class
    {
        ...
        {
            return Task.Factory.StartNew(() => Add(entity), cancellationToken);
        }
    ...
    public class Alpha_Harish3485Configuration : IEntityTypeConfiguration<Alpha_Harish3485>
    {
        public void Configure(EntityTypeBuilder<Alpha_Harish3485> builder)
        {
            ...
            builder.HasKey(x => x.Id).HasName("PK_Alpha_Harish3485").ForSqlServerIsClustered();
    ...
    public class Beta_Harish3485Configuration : IEntityTypeConfiguration<Beta_Harish3485>
    {
        public void Configure(EntityTypeBuilder<Beta_Harish3485> builder)
        {
            ...
            builder.HasKey(x => x.Id).HasName("PK_Beta_Harish3485").ForSqlServerIsClustered();
    ...
    public class dcg_RovColumnDefinitionConfiguration : IEntityTypeConfiguration<dcg_RovColumnDefinition>
    {
        ...
        {
            builder.ToTable("rov_ColumnDefinitions", "dcg");
            ...
            builder.Property(x => x.TableName).HasColumnName(@"TABLE_NAME").HasColumnType("nvarchar(128)").IsRequired().HasMaxLength(128).ValueGeneratedNever();
    ...
    public class TimestampNotNullConfiguration : IEntityTypeConfiguration<TimestampNotNull>
    {
        public void Configure(EntityTypeBuilder<TimestampNotNull> builder)
        {
            ...
            builder.HasKey(x => x.Id).HasName("PK_TimestampNotNull").ForSqlServerIsClustered();
    ...
    public class TimestampNullableConfiguration : IEntityTypeConfiguration<TimestampNullable>
    {
        public void Configure(EntityTypeBuilder<TimestampNullable> builder)
        {
            ...
            builder.HasKey(x => x.Id).HasName("PK_TTimestampNullable").ForSqlServerIsClustered();
    ...
    public class VersionedConfiguration : IEntityTypeConfiguration<Versioned>
    {
        public void Configure(EntityTypeBuilder<Versioned> builder)
        {
            ...
            builder.HasKey(x => x.Id).HasName("PK_Versioned").ForSqlServerIsClustered();
