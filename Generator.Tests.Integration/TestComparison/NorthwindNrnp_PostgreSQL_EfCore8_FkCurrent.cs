...
namespace Efrpg.PostgreSQL
{
    ...
    public class FakeMyDbContext : IMyDbContext
    {
        ...
        public DbSet<CustomerCustomerDemo> CustomerCustomerDemoes { get; set; } = null!; // customer_customer_demo
        public DbSet<CustomerDemographic> CustomerDemographics { get; set; } = null!; // customer_demographics
        public DbSet<Employee> Employees { get; set; } = null!; // employees
        public DbSet<EmployeeTerritory> EmployeeTerritories { get; set; } = null!; // employee_territories
        public DbSet<Order> Orders { get; set; } = null!; // orders
        public DbSet<OrderDetail> OrderDetails { get; set; } = null!; // order_details
        ...
        public DbSet<UsState> UsStates { get; set; } = null!; // us_states
    ...
    {
        public string CustomerId { get; set; } = null!; // customer_id (Primary key) (length: 5)
        public string CompanyName { get; set; } = null!; // company_name (length: 40)
    ...
    {
        public string CustomerId { get; set; } = null!; // customer_id (Primary key) (length: 5)
        public string CustomerTypeId { get; set; } = null!; // customer_type_id (Primary key) (length: 5)
        ...
        /// </summary>
        public virtual Customer Customer { get; set; } = null!; // fk_customer_customer_demo_customers
        ...
        /// </summary>
        public virtual CustomerDemographic CustomerDemographic { get; set; } = null!; // fk_customer_customer_demo_customer_demographics
    }
    ...
    public class Employee
    {
        ...
        public string LastName { get; set; } = null!; // last_name (length: 20)
        public string FirstName { get; set; } = null!; // first_name (length: 10)
    ...
    {
        public short EmployeeId { get; set; } // employee_id (Primary key)
        public string TerritoryId { get; set; } = null!; // territory_id (Primary key) (length: 20)
        ...
        /// </summary>
        public virtual Employee Employee { get; set; } = null!; // fk_employee_territories_employees

        /// <summary>
        /// Parent Territory pointed by [employee_territories].([TerritoryId]) (fk_employee_territories_territories)
        /// </summary>
        public virtual Territory Territory { get; set; } = null!; // fk_employee_territories_territories
    }
    ...
    public class OrderDetail
    {
        ...
        /// </summary>
        public virtual Order Order { get; set; } = null!; // fk_order_details_orders

        /// <summary>
        /// Parent Product pointed by [order_details].([ProductId]) (fk_order_details_products)
        /// </summary>
        public virtual Product Product { get; set; } = null!; // fk_order_details_products
    }
    ...
    {
        public short ProductId { get; set; } // product_id (Primary key)
        public string ProductName { get; set; } = null!; // product_name (length: 40)
    ...
    public class Region
    {
        ...
        public string RegionDescription { get; set; } = null!; // region_description (length: 60)
    ...
    {
        public string TerritoryId { get; set; } = null!; // territory_id (Primary key) (length: 20)
        public string TerritoryDescription { get; set; } = null!; // territory_description (length: 60)
        ...
        /// </summary>
        public virtual Region Region { get; set; } = null!; // fk_territories_region
