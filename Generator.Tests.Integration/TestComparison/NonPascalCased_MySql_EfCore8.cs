...
namespace Efrpg.MySql
{
    ...
    public class SpacedTableNameConfiguration : IEntityTypeConfiguration<SpacedTableName>
    {
        public void Configure(EntityTypeBuilder<SpacedTableName> builder)
        {
            ...
            builder.Property(x => x.Column_With_Hyphens).HasColumnName(@"Column-With-Hyphens").HasColumnType("varchar(50)").IsRequired(false).IsUnicode(false).HasMaxLength(50);
            ...
            builder.Property(x => x._event).HasColumnName(@"event").HasColumnType("varchar(50)").IsRequired(false).IsUnicode(false).HasMaxLength(50).HasComment(@"Reserved in C#");
