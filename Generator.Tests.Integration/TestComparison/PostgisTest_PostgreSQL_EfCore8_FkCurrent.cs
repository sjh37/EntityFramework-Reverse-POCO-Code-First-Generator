...
namespace Efrpg.PostgreSQL
{
    ...
    {
        public DbSet<dbo_TestPostGisTbl> dbo_TestPostGisTbls { get; set; } = null!; // TestPostGisTbl
        public DbSet<GeographyColumn> GeographyColumns { get; set; } = null!; // geography_columns
        public DbSet<GeometryColumn> GeometryColumns { get; set; } = null!; // geometry_columns
        public DbSet<SpatialRefSy> SpatialRefSies { get; set; } = null!; // spatial_ref_sys
    ...
    public class dbo_TestPostGisTbl
    {
        ...
        public string AtdLocation { get; set; } = null!; // ATDLocation
    }
