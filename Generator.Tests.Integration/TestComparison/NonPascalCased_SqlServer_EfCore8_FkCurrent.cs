...
namespace Efrpg.V4TestE8
{
    ...
    public interface IEfrpg_db_context : IDisposable
    {
        ...
        int App_usp_CMTUserFSRUpdate(int? userId, int? fsrId, ref int? ufsrId);
        ...
        List<stp_testReturnModel> stp_test(string strDateFROM, string strDateTo, ref bool? retBool);
        List<stp_testReturnModel> stp_test(string strDateFROM, string strDateTo, ref bool? retBool, out int procResult);
    ...
    public class Efrpg_db_context : DbContext, IEfrpg_db_context
    {
        ...
        public int App_usp_CMTUserFSRUpdate(int? userId, int? fsrId, ref int? ufsrId)
        {
        ...
        public int proc_TestDecimalOutput(ref decimal? perfectNumber)
        {
        ...
        public int proc_TestDecimalOutputV2(ref decimal? perfectNumber)
        {
        ...
        public int proc_TestDecimalOutputV3Default(ref decimal? perfectNumber)
        {
        ...
        public List<stp_testReturnModel> stp_test(string strDateFROM, string strDateTo, ref bool? retBool)
        {
            int procResult;
            return stp_test(strDateFROM, strDateTo, ref retBool, out procResult);
        }

        public List<stp_testReturnModel> stp_test(string strDateFROM, string strDateTo, ref bool? retBool, out int procResult)
        {
    ...
    public class FakeEfrpg_db_context : IEfrpg_db_context
    {
        ...
        public DbSet<AB_OrderLinesAB> AB_OrderLinesABs { get; set; } = null!; // AB_OrderLinesAB_
        public DbSet<AB_OrdersAB> AB_OrdersABs { get; set; } = null!; // AB_OrdersAB_
        ...
        public DbSet<alpha_workflow_synonym> alpha_workflow_synonyms { get; set; } = null!; // alpha_workflow_synonym
        ...
        public DbSet<BlahBlahLink_v2> BlahBlahLink_v2 { get; set; } = null!; // BlahBlahLink_v2
        ...
        public DbSet<CMS_File> CMS_Files { get; set; } = null!; // CMS_File
        public DbSet<CMS_Tag> CMS_Tags { get; set; } = null!; // CMS_Tag
        public DbSet<CODE_MeetingTopicDetail> CODE_MeetingTopicDetails { get; set; } = null!; // CODE_MeetingTopicDetails
        public DbSet<CODE_PARAM_MeetingTopicDetailSource> CODE_PARAM_MeetingTopicDetailSources { get; set; } = null!; // CODE_PARAM_MeetingTopicDetailSource
        ...
        public DbSet<hierarchy_test> hierarchy_tests { get; set; } = null!; // hierarchy_test
        ...
        public DbSet<Period_Table> Period_Tables { get; set; } = null!; // Period.Table
        ...
        public DbSet<table_with_multiple_period> table_with_multiple_periods { get; set; } = null!; // table.with.multiple.periods
        ...
        public DbSet<User_Document> User_Documents { get; set; } = null!; // User_Document
        ...
        public DbSet<view_with_multiple_period> view_with_multiple_periods { get; set; } = null!; // view.with.multiple.periods
        ...
        public DbSet<WVN_v_Article> WVN_v_Articles { get; set; } = null!; // v_Articles
        ...
        public DbSet<TEntity> Set<TEntity>() where TEntity : class
        {
            ...
            if (property == null)
                throw new InvalidOperationException("Cannot find a DbSet<" + typeof(TEntity).Name + "> on FakeEfrpg_db_context. The entity type is not part of this context.");
        ...
        public DbSet<C182_test2ReturnModel> C182_test2ReturnModel { get; set; } = null!;
        public C182_test2ReturnModel C182_test2(int? flag = 1)
        {
            int procResult;
        ...
        public DbSet<dbo_proc_data_from_ffrsReturnModel> dbo_proc_data_from_ffrsReturnModel { get; set; } = null!;
        public List<dbo_proc_data_from_ffrsReturnModel> dbo_proc_data_from_ffrs(int? maxId = null)
        {
            int procResult;
            return dbo_proc_data_from_ffrs(maxId, out procResult);
        ...
        public DbSet<dbo_proc_data_from_ffrs_and_dboReturnModel> dbo_proc_data_from_ffrs_and_dboReturnModel { get; set; } = null!;
        public List<dbo_proc_data_from_ffrs_and_dboReturnModel> dbo_proc_data_from_ffrs_and_dbo()
        {
            int procResult;
            return dbo_proc_data_from_ffrs_and_dbo(out procResult);
        ...
        public DbSet<FFRS_cv_dataReturnModel> FFRS_cv_dataReturnModel { get; set; } = null!;
        public List<FFRS_cv_dataReturnModel> FFRS_cv_data(int? maxId = null)
        {
            int procResult;
            return FFRS_cv_data(maxId, out procResult);
        ...
        public DbSet<FFRS_data_from_dboReturnModel> FFRS_data_from_dboReturnModel { get; set; } = null!;
        public List<FFRS_data_from_dboReturnModel> FFRS_data_from_dbo()
        {
            int procResult;
            return FFRS_data_from_dbo(out procResult);
        ...
        public DbSet<FFRS_data_from_dbo_and_ffrsReturnModel> FFRS_data_from_dbo_and_ffrsReturnModel { get; set; } = null!;
        public List<FFRS_data_from_dbo_and_ffrsReturnModel> FFRS_data_from_dbo_and_ffrs()
        {
            int procResult;
            return FFRS_data_from_dbo_and_ffrs(out procResult);
        ...
        public DbSet<stp_multiple_identical_resultsReturnModel> stp_multiple_identical_resultsReturnModel { get; set; } = null!;
        public List<stp_multiple_identical_resultsReturnModel> stp_multiple_identical_results(int? someVar = null)
        {
            int procResult;
            return stp_multiple_identical_results(someVar, out procResult);
        ...
        public DbSet<stp_multiple_multiple_results_with_paramsReturnModel> stp_multiple_multiple_results_with_paramsReturnModel { get; set; } = null!;
        ...
        public DbSet<stp_multiple_resultsReturnModel> stp_multiple_resultsReturnModel { get; set; } = null!;
        ...
        public DbSet<stp_multiple_results_with_paramsReturnModel> stp_multiple_results_with_paramsReturnModel { get; set; } = null!;
        ...
        public DbSet<stp_no_params_testReturnModel> stp_no_params_testReturnModel { get; set; } = null!;
        public List<stp_no_params_testReturnModel> stp_no_params_test()
        {
            int procResult;
            return stp_no_params_test(out procResult);
        ...
        public DbSet<stp_nullable_params_testReturnModel> stp_nullable_params_testReturnModel { get; set; } = null!;
        public List<stp_nullable_params_testReturnModel> stp_nullable_params_test(int? aval = null, int? bval = null)
        {
            int procResult;
            return stp_nullable_params_test(aval, bval, out procResult);
        ...
        public DbSet<stp_testReturnModel> stp_testReturnModel { get; set; } = null!;
        public List<stp_testReturnModel> stp_test(string strDateFROM, string strDateTo, ref bool? retBool)
        {
            int procResult;
            return stp_test(strDateFROM, strDateTo, ref retBool, out procResult);
        ...
        public DbSet<stp_test_underscore_testReturnModel> stp_test_underscore_testReturnModel { get; set; } = null!;
        public List<stp_test_underscore_testReturnModel> stp_test_underscore_test(string strDateFROM, string strdateto)
        {
            int procResult;
            return stp_test_underscore_test(strDateFROM, strdateto, out procResult);
