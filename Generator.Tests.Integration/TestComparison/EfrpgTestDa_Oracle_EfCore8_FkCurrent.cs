...
namespace Efrpg.Oracle
{
    ...
    /// </summary>
    [Table("ACTIVE_CHILDREN", Schema = "EFRPGTEST")]
    [Comment(@"A view has no keys and no relationships")]
    ...
    // ALL_COLUMNS_NULL
    [Table("ALL_COLUMNS_NULL", Schema = "EFRPGTEST")]
    ...
    [Table("ALL_COLUMNS_NULL_VIEW", Schema = "EFRPGTEST")]
    ...
    /// </summary>
    [Table("ALL_COLUMN_TYPES", Schema = "EFRPGTEST")]
    [Comment(@"One column per Oracle type, to exercise the language mapping")]
    public class AllColumnType
    {
        ...
        [Comment(@"NUMBER(1) is how Oracle spells a bool")]
        ...
        [Display(Name = "Number 19")]
        public long? Number19 { get; set; } // NUMBER_19

        [Display(Name = "Number 18 4")]
        [Precision(18, 4)]
        ...
        /// </summary>
        [Display(Name = "Number no precision")]
        [Comment(@"Arbitrary precision, so decimal is the only safe mapping")]
        ...
        [Display(Name = "Clob col")]
        public string ClobCol { get; set; } // CLOB_COL

        [Display(Name = "Nclob col")]
    ...
    [Table("CASE_ONLY_DIFFERENCE", Schema = "EFRPGTEST")]
    ...
    // CHILD_COMPOSITE
    [Table("CHILD_COMPOSITE", Schema = "EFRPGTEST")]
    ...
    /// </summary>
    [Table("DEFAULTS_AND_GENERATED", Schema = "EFRPGTEST")]
    [Comment(@"Column defaults and a virtual column")]
    ...
    // IDENTITY_ALWAYS
    [Table("IDENTITY_ALWAYS", Schema = "EFRPGTEST")]
    ...
    // IDENTITY_BY_DEFAULT
    [Table("IDENTITY_BY_DEFAULT", Schema = "EFRPGTEST")]
    ...
    // INDEX_TEST
    [Table("INDEX_TEST", Schema = "EFRPGTEST")]
    ...
    // IOT_TABLE
    [Table("IOT_TABLE", Schema = "EFRPGTEST")]
    ...
    // LEGACY_IDENTITY
    [Table("LEGACY_IDENTITY", Schema = "EFRPGTEST")]
    ...
    // LONG_COLUMN_TABLE
    [Table("LONG_COLUMN_TABLE", Schema = "EFRPGTEST")]
    ...
    // NO_PRIMARY_KEY
    [Table("NO_PRIMARY_KEY", Schema = "EFRPGTEST")]
    ...
    // ORDER_STATUS
    [Table("ORDER_STATUS", Schema = "EFRPGTEST")]
    ...
    [Table("ORDER_STATUS_SUMMARY", Schema = "EFRPGTEST")]
    ...
    // PARENT_COMPOSITE
    [Table("PARENT_COMPOSITE", Schema = "EFRPGTEST")]
    public class ParentComposite
    {
        [Key, Column(Order = 1)]
        [Required]
        [Display(Name = "Key one")]
        [DatabaseGenerated(DatabaseGeneratedOption.None)]
        public int KeyOne { get; set; } // KEY_ONE (Primary key)

        [Key, Column(Order = 2)]
        [Required]
        [Display(Name = "Key two")]
        [DatabaseGenerated(DatabaseGeneratedOption.None)]
    ...
    // PERSON_PHOTO
    [Table("PERSON_PHOTO", Schema = "EFRPGTEST")]
    ...
    // PK_ORDINAL_TEST
    [Table("PK_ORDINAL_TEST", Schema = "EFRPGTEST")]
    ...
    // PRINCIPAL_KEY_CHILD
    [Table("PRINCIPAL_KEY_CHILD", Schema = "EFRPGTEST")]
    ...
    [Comment(@"Every identifier here needs quoting")]
    public class SpacedTableName
    {
        ...
        [MaxLength(50)]
        [StringLength(50)]
        [Display(Name = "Column with spaces")]
        ...
        [MaxLength(50)]
        [StringLength(50)]
        [Display(Name = "Table with periods")]
    ...
    // STUDENT_COURSE
    [Table("STUDENT_COURSE", Schema = "EFRPGTEST")]
    ...
    // UNENFORCED_CHILD
    [Table("UNENFORCED_CHILD", Schema = "EFRPGTEST")]
    ...
    // UNENFORCED_PARENT
    [Table("UNENFORCED_PARENT", Schema = "EFRPGTEST")]
    ...
    public class ActiveChildConfiguration : IEntityTypeConfiguration<ActiveChild>
    {
        public void Configure(EntityTypeBuilder<ActiveChild> builder)
        {
            ...
            builder.Property(x => x.ChildId).HasColumnName(@"CHILD_ID").HasColumnType("number");
            builder.Property(x => x.Description).HasColumnName(@"DESCRIPTION").HasColumnType("varchar2(50)").IsRequired(false);
            builder.Property(x => x.ParentName).HasColumnName(@"PARENT_NAME").HasColumnType("varchar2(50)");
        }
    }
    ...
    public class AirportConfiguration : IEntityTypeConfiguration<Airport>
    {
        public void Configure(EntityTypeBuilder<Airport> builder)
        {
            ...
            builder.Property(x => x.AirportId).HasColumnName(@"AIRPORT_ID").HasColumnType("number(10)");
            builder.Property(x => x.Name).HasColumnName(@"NAME").HasColumnType("varchar2(50)");
        }
    }
    ...
    public class AllColumnsNullViewConfiguration : IEntityTypeConfiguration<AllColumnsNullView>
    {
        public void Configure(EntityTypeBuilder<AllColumnsNullView> builder)
        {
            ...
            builder.Property(x => x.B).HasColumnName(@"B").HasColumnType("varchar2(50)").IsRequired(false);
    ...
    public class AllColumnTypeConfiguration : IEntityTypeConfiguration<AllColumnType>
    {
        public void Configure(EntityTypeBuilder<AllColumnType> builder)
        {
            ...
            builder.Property(x => x.Id).HasColumnName(@"ID").HasColumnType("number(19)");
            builder.Property(x => x.Number1).HasColumnName(@"NUMBER_1").HasColumnType("number(1)").IsRequired(false);
            ...
            builder.Property(x => x.Number184).HasColumnName(@"NUMBER_18_4").HasColumnType("number").IsRequired(false);
            builder.Property(x => x.NumberNoPrecision).HasColumnName(@"NUMBER_NO_PRECISION").HasColumnType("number").IsRequired(false);
            builder.Property(x => x.FloatCol).HasColumnName(@"FLOAT_COL").HasColumnType("float").IsRequired(false);
            builder.Property(x => x.Float126).HasColumnName(@"FLOAT_126").HasColumnType("float").IsRequired(false);
            ...
            builder.Property(x => x.CharCol).HasColumnName(@"CHAR_COL").HasColumnType("char(10)").IsRequired(false).IsFixedLength();
            builder.Property(x => x.NcharCol).HasColumnName(@"NCHAR_COL").HasColumnType("nchar(10)").IsRequired(false).IsFixedLength();
            builder.Property(x => x.Varchar2Col).HasColumnName(@"VARCHAR2_COL").HasColumnType("varchar2(255)").IsRequired(false);
            builder.Property(x => x.Nvarchar2Col).HasColumnName(@"NVARCHAR2_COL").HasColumnType("nvarchar2(255)").IsRequired(false);
            ...
            builder.Property(x => x.RawCol).HasColumnName(@"RAW_COL").HasColumnType("raw(2000)").IsRequired(false);
            ...
            builder.Property(x => x.XmlCol).HasColumnName(@"XML_COL").HasColumnType("xmltype").IsRequired(false);
        }
    }
    ...
    public class CaseOnlyDifferenceConfiguration : IEntityTypeConfiguration<CaseOnlyDifference>
    {
        public void Configure(EntityTypeBuilder<CaseOnlyDifference> builder)
        {
            ...
            builder.Property(x => x.Id).HasColumnName(@"ID").HasColumnType("number(10)");
            builder.Property(x => x.Value1).HasColumnName(@"Value").HasColumnType("varchar2(10)").IsRequired(false);
            builder.Property(x => x.Value).HasColumnName(@"value").HasColumnType("varchar2(10)").IsRequired(false);
        }
    }
    ...
    public class ChildCompositeConfiguration : IEntityTypeConfiguration<ChildComposite>
    {
        public void Configure(EntityTypeBuilder<ChildComposite> builder)
        {
            ...
            builder.Property(x => x.ChildId).HasColumnName(@"CHILD_ID").HasColumnType("number").ValueGeneratedOnAdd();
            builder.Property(x => x.ParentKeyOne).HasColumnName(@"PARENT_KEY_ONE").HasColumnType("number(10)");
            builder.Property(x => x.ParentKeyTwo).HasColumnName(@"PARENT_KEY_TWO").HasColumnType("number(10)");
            builder.Property(x => x.Description).HasColumnName(@"DESCRIPTION").HasColumnType("varchar2(50)").IsRequired(false);
    ...
    public class CourseConfiguration : IEntityTypeConfiguration<Course>
    {
        public void Configure(EntityTypeBuilder<Course> builder)
        {
            ...
            builder.Property(x => x.CourseId).HasColumnName(@"COURSE_ID").HasColumnType("number").ValueGeneratedOnAdd();
            builder.Property(x => x.Title).HasColumnName(@"TITLE").HasColumnType("varchar2(100)");
        }
    }
    ...
    public class DefaultsAndGeneratedConfiguration : IEntityTypeConfiguration<DefaultsAndGenerated>
    {
        public void Configure(EntityTypeBuilder<DefaultsAndGenerated> builder)
        {
            ...
            builder.Property(x => x.Quantity).HasColumnName(@"QUANTITY").HasColumnType("number(10)");
    ...
    public class EmployeeConfiguration : IEntityTypeConfiguration<Employee>
    {
        public void Configure(EntityTypeBuilder<Employee> builder)
        {
            ...
            builder.Property(x => x.EmployeeId).HasColumnName(@"EMPLOYEE_ID").HasColumnType("number").ValueGeneratedOnAdd();
            builder.Property(x => x.ManagerId).HasColumnName(@"MANAGER_ID").HasColumnType("number(19)").IsRequired(false);
            builder.Property(x => x.FullName).HasColumnName(@"FULL_NAME").HasColumnType("varchar2(100)");
    ...
    public class FlightConfiguration : IEntityTypeConfiguration<Flight>
    {
        public void Configure(EntityTypeBuilder<Flight> builder)
        {
            ...
            builder.Property(x => x.FlightId).HasColumnName(@"FLIGHT_ID").HasColumnType("number").ValueGeneratedOnAdd();
            builder.Property(x => x.DepartureAirportId).HasColumnName(@"DEPARTURE_AIRPORT_ID").HasColumnType("number(10)");
            builder.Property(x => x.ArrivalAirportId).HasColumnName(@"ARRIVAL_AIRPORT_ID").HasColumnType("number(10)");
    ...
    public class IndexTestConfiguration : IEntityTypeConfiguration<IndexTest>
    {
        public void Configure(EntityTypeBuilder<IndexTest> builder)
        {
            ...
            builder.Property(x => x.Id).HasColumnName(@"ID").HasColumnType("number").ValueGeneratedOnAdd();
            builder.Property(x => x.UniqueCol).HasColumnName(@"UNIQUE_COL").HasColumnType("number(10)");
            builder.Property(x => x.LowerMe).HasColumnName(@"LOWER_ME").HasColumnType("varchar2(50)");
            builder.Property(x => x.A).HasColumnName(@"A").HasColumnType("number(10)");
            builder.Property(x => x.B).HasColumnName(@"B").HasColumnType("number(10)");
    ...
    public class IotTableConfiguration : IEntityTypeConfiguration<IotTable>
    {
        public void Configure(EntityTypeBuilder<IotTable> builder)
        {
            ...
            builder.Property(x => x.Id).HasColumnName(@"ID").HasColumnType("number(10)");
            builder.Property(x => x.Value1).HasColumnName(@"VALUE1").HasColumnType("varchar2(50)").IsRequired(false);
        }
    }
    ...
    public class NoPrimaryKeyConfiguration : IEntityTypeConfiguration<NoPrimaryKey>
    {
        public void Configure(EntityTypeBuilder<NoPrimaryKey> builder)
        {
            ...
            builder.Property(x => x.A).HasColumnName(@"A").HasColumnType("number(10)");
            builder.Property(x => x.B).HasColumnName(@"B").HasColumnType("varchar2(50)");
        }
    }
    ...
    public class OrderStatusConfiguration : IEntityTypeConfiguration<OrderStatus>
    {
        public void Configure(EntityTypeBuilder<OrderStatus> builder)
        {
            ...
            builder.Property(x => x.OrderStatusId).HasColumnName(@"ORDER_STATUS_ID").HasColumnType("number(10)");
            builder.Property(x => x.Name).HasColumnName(@"NAME").HasColumnType("varchar2(30)");
            builder.Property(x => x.StatusGroup).HasColumnName(@"STATUS_GROUP").HasColumnType("varchar2(20)");
            builder.Property(x => x.Description).HasColumnName(@"DESCRIPTION").HasColumnType("varchar2(100)").IsRequired(false);
        }
    }
    ...
    public class ParentCompositeConfiguration : IEntityTypeConfiguration<ParentComposite>
    {
        public void Configure(EntityTypeBuilder<ParentComposite> builder)
        {
            ...
            builder.Property(x => x.KeyOne).HasColumnName(@"KEY_ONE").HasColumnType("number(10)");
            builder.Property(x => x.KeyTwo).HasColumnName(@"KEY_TWO").HasColumnType("number(10)");
            builder.Property(x => x.AltKey).HasColumnName(@"ALT_KEY").HasColumnType("number(10)");
            builder.Property(x => x.Name).HasColumnName(@"NAME").HasColumnType("varchar2(50)");
    ...
    public class PersonConfiguration : IEntityTypeConfiguration<Person>
    {
        public void Configure(EntityTypeBuilder<Person> builder)
        {
            ...
            builder.Property(x => x.PersonId).HasColumnName(@"PERSON_ID").HasColumnType("number").ValueGeneratedOnAdd();
            builder.Property(x => x.FullName).HasColumnName(@"FULL_NAME").HasColumnType("varchar2(100)");
        }
    }
    ...
    public class PersonPhotoConfiguration : IEntityTypeConfiguration<PersonPhoto>
    {
        public void Configure(EntityTypeBuilder<PersonPhoto> builder)
        {
            ...
            builder.Property(x => x.PersonId).HasColumnName(@"PERSON_ID").HasColumnType("number");
    ...
    public class PkOrdinalTestConfiguration : IEntityTypeConfiguration<PkOrdinalTest>
    {
        public void Configure(EntityTypeBuilder<PkOrdinalTest> builder)
        {
            ...
            builder.Property(x => x.Filler).HasColumnName(@"FILLER").HasColumnType("varchar2(10)").IsRequired(false);
            builder.Property(x => x.SecondKey).HasColumnName(@"SECOND_KEY").HasColumnType("number(10)");
            builder.Property(x => x.FirstKey).HasColumnName(@"FIRST_KEY").HasColumnType("number(10)");
        }
    }
    ...
    public class PrincipalKeyChildConfiguration : IEntityTypeConfiguration<PrincipalKeyChild>
    {
        public void Configure(EntityTypeBuilder<PrincipalKeyChild> builder)
        {
            ...
            builder.Property(x => x.Id).HasColumnName(@"ID").HasColumnType("number").ValueGeneratedOnAdd();
            builder.Property(x => x.ParentAltKey).HasColumnName(@"PARENT_ALT_KEY").HasColumnType("number(10)");
    ...
    public class SpacedTableNameConfiguration : IEntityTypeConfiguration<SpacedTableName>
    {
        public void Configure(EntityTypeBuilder<SpacedTableName> builder)
        {
            ...
            builder.Property(x => x.SpacedTableName_).HasColumnName(@"Spaced Table Name").HasColumnType("number").ValueGeneratedOnAdd();
            builder.Property(x => x.ColumnWithSpaces).HasColumnName(@"Column With Spaces").HasColumnType("varchar2(50)").IsRequired(false);
            builder.Property(x => x.ColumnWithHyphens).HasColumnName(@"Column-With-Hyphens").HasColumnType("varchar2(50)").IsRequired(false);
            builder.Property(x => x.C1LeadingDigit).HasColumnName(@"1_leading_digit").HasColumnType("number(10)").IsRequired(false);
            builder.Property(x => x.Select).HasColumnName(@"select").HasColumnType("varchar2(50)").IsRequired(false);
            builder.Property(x => x.@Class).HasColumnName(@"class").HasColumnType("varchar2(50)").IsRequired(false);
            builder.Property(x => x.Event).HasColumnName(@"event").HasColumnType("varchar2(50)").IsRequired(false);
            builder.Property(x => x.@Namespace).HasColumnName(@"namespace").HasColumnType("varchar2(50)").IsRequired(false);
            builder.Property(x => x.@String).HasColumnName(@"string").HasColumnType("varchar2(50)").IsRequired(false);
            builder.Property(x => x.TableWithPeriods).HasColumnName(@"table.with.periods").HasColumnType("varchar2(50)").IsRequired(false);
        }
    }
    ...
    public class StudentConfiguration : IEntityTypeConfiguration<Student>
    {
        public void Configure(EntityTypeBuilder<Student> builder)
        {
            ...
            builder.Property(x => x.StudentId).HasColumnName(@"STUDENT_ID").HasColumnType("number").ValueGeneratedOnAdd();
            builder.Property(x => x.FullName).HasColumnName(@"FULL_NAME").HasColumnType("varchar2(100)");
        }
    }
    ...
    public class StudentCourseConfiguration : IEntityTypeConfiguration<StudentCourse>
    {
        public void Configure(EntityTypeBuilder<StudentCourse> builder)
        {
            ...
            builder.Property(x => x.StudentId).HasColumnName(@"STUDENT_ID").HasColumnType("number");
            builder.Property(x => x.CourseId).HasColumnName(@"COURSE_ID").HasColumnType("number");
