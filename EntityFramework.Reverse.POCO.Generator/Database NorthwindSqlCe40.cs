...
namespace EntityFramework_Reverse_POCO_Generator.SqlCe4
{
    ...
    public class MyDbContextSqlCE4 : DbContext, IMyDbContextSqlCE4
    {
        ...
        protected MyDbContextSqlCE4(DbContextOptions options)
            : base(options)
        {
        }
    ...
    public class FakeMyDbContextSqlCE4 : IMyDbContextSqlCE4
    {
        ...
        public DbSet<TEntity> Set<TEntity>() where TEntity : class
        {
            ...
            if (property == null)
                throw new InvalidOperationException("Cannot find a DbSet<" + typeof(TEntity).Name + "> on FakeMyDbContextSqlCE4. The entity type is not part of this context.");
