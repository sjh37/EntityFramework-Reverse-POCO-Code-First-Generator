...
namespace Efrpg.V3TestE
{
    ...
    public class MyDbContext : DbContext, IMyDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Table Valued Functions
            modelBuilder.Query<ProductsUnderThisUnitPriceReturnModel>();
        }
        ...
        public List<CustOrderHistReturnModel> CustOrderHist(string customerId, out int procResult)
        {
            ...
            var procResultData = Query<CustOrderHistReturnModel>()
                .FromSql(sqlCommand, customerIdParam, procResultParam)
                .ToList();
        ...
        public async Task<List<CustOrderHistReturnModel>> CustOrderHistAsync(string customerId)
        {
            ...
            var procResultData = await Query<CustOrderHistReturnModel>()
                .FromSql(sqlCommand, customerIdParam)
                .ToListAsync();
        ...
        public List<CustOrdersDetailReturnModel> CustOrdersDetail(int? orderId, out int procResult)
        {
            ...
            var procResultData = Query<CustOrdersDetailReturnModel>()
                .FromSql(sqlCommand, orderIdParam, procResultParam)
                .ToList();
        ...
        public async Task<List<CustOrdersDetailReturnModel>> CustOrdersDetailAsync(int? orderId)
        {
            ...
            var procResultData = await Query<CustOrdersDetailReturnModel>()
                .FromSql(sqlCommand, orderIdParam)
                .ToListAsync();
        ...
        public List<CustOrdersOrdersReturnModel> CustOrdersOrders(string customerId, out int procResult)
        {
            ...
            var procResultData = Query<CustOrdersOrdersReturnModel>()
                .FromSql(sqlCommand, customerIdParam, procResultParam)
                .ToList();
        ...
        public async Task<List<CustOrdersOrdersReturnModel>> CustOrdersOrdersAsync(string customerId)
        {
            ...
            var procResultData = await Query<CustOrdersOrdersReturnModel>()
                .FromSql(sqlCommand, customerIdParam)
                .ToListAsync();
        ...
        public List<EmployeeSalesByCountryReturnModel> EmployeeSalesByCountry(DateTime? beginningDate, DateTime? endingDate, out int procResult)
        {
            ...
            var procResultData = Query<EmployeeSalesByCountryReturnModel>()
                .FromSql(sqlCommand, beginningDateParam, endingDateParam, procResultParam)
                .ToList();
        ...
        public async Task<List<EmployeeSalesByCountryReturnModel>> EmployeeSalesByCountryAsync(DateTime? beginningDate, DateTime? endingDate)
        {
            ...
            var procResultData = await Query<EmployeeSalesByCountryReturnModel>()
                .FromSql(sqlCommand, beginningDateParam, endingDateParam)
                .ToListAsync();
        ...
        public List<SalesByCategoryReturnModel> SalesByCategory(string categoryName, string ordYear, out int procResult)
        {
            ...
            var procResultData = Query<SalesByCategoryReturnModel>()
                .FromSql(sqlCommand, categoryNameParam, ordYearParam, procResultParam)
                .ToList();
        ...
        public async Task<List<SalesByCategoryReturnModel>> SalesByCategoryAsync(string categoryName, string ordYear)
        {
            ...
            var procResultData = await Query<SalesByCategoryReturnModel>()
                .FromSql(sqlCommand, categoryNameParam, ordYearParam)
                .ToListAsync();
        ...
        public List<SalesByYearReturnModel> SalesByYear(DateTime? beginningDate, DateTime? endingDate, out int procResult)
        {
            ...
            var procResultData = Query<SalesByYearReturnModel>()
                .FromSql(sqlCommand, beginningDateParam, endingDateParam, procResultParam)
                .ToList();
        ...
        public async Task<List<SalesByYearReturnModel>> SalesByYearAsync(DateTime? beginningDate, DateTime? endingDate)
        {
            ...
            var procResultData = await Query<SalesByYearReturnModel>()
                .FromSql(sqlCommand, beginningDateParam, endingDateParam)
                .ToListAsync();
        ...
        public List<TenMostExpensiveProductsReturnModel> TenMostExpensiveProducts(out int procResult)
        {
            ...
            var procResultData = Query<TenMostExpensiveProductsReturnModel>()
        ...
        public async Task<List<TenMostExpensiveProductsReturnModel>> TenMostExpensiveProductsAsync()
        {
            ...
            var procResultData = await Query<TenMostExpensiveProductsReturnModel>()
                .FromSql(sqlCommand)
                .ToListAsync();
        ...
        {
            return Query<ProductsUnderThisUnitPriceReturnModel>()
                .FromSql("SELECT * FROM [dbo].[ProductsUnderThisUnitPrice]({0})", price)
                .AsNoTracking();
        }
