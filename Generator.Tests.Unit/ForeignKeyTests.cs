    ...
    public class ForeignKeyTests
    {
        ...
        public void OneTimeSetUp()
        {
            rawForeignKeys = new List<RawForeignKey>
            {
                ...
                new RawForeignKey("FK_PersonPosts_CreatedBy", null, null, "Id", "CreatedBy", "dbo", "Perso", "dbo", "PersonPosts", 1, false, false, false),
                new RawForeignKey("FK_PersonPosts_UpdatedBy", null, null, "Id", "UpdatedBy", "dbo", "Perso", "dbo", "PersonPosts", 1, false, false, false),
                ...
                new RawForeignKey("FK_User_PhoneCountry", null, null, "CountryID", "PhoneCountryID", "dbo", "Country", "dbo", "User", 1, false, false, false),
            ...
            rawIndexes = new List<RawIndex>
            {
                ...
                new RawIndex("dbo", "BringTheAction", "PK__BringThe__3BD01849C76137D5", 1, "$", 1, true, true, false, true),
                ...
                new RawIndex("dbo", "CMS_File", "PK_CMS_Form", 1, "FileId", 1, true, true, false, true),
                ...
                new RawIndex("dbo", "table mapping with space", "map_with_space", 1, "id", 2, true, true, false, true),
                new RawIndex("dbo", "table mapping with space", "map_with_space", 2, "id value", 2, true, true, false, true),
                ...
                new RawIndex("dbo", "User", "PK_User", 1, "UserID", 1, true, true, false, true),
        ...
        public void IdentifyUniqueForeignKeys()
        {
            ...
            Assert.AreEqual(8, rawForeignKeys.Count(x => x.HasUniqueConstraint));
