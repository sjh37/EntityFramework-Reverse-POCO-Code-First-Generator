    ...
    public class ForeignKeyTests
    {
        ...
        public void OneTimeSetUp()
        {
            rawForeignKeys = new List<RawForeignKey>
            {
                ...
                new RawForeignKey("FK_Burak1_Burak2", null, null, "id", "id_t", "dbo", "Burak2", "dbo", "Burak1", 1, false, false, false),
                new RawForeignKey("FK_Burak_Test2", null, null, "num", "num", "dbo", "Burak2", "dbo", "Burak1", 2, false, false, false),
                new RawForeignKey("FK_Burak1_Burak2", null, null, "num", "num", "dbo", "Burak2", "dbo", "Burak1", 2, false, false, false),
            ...
            rawIndexes = new List<RawIndex>
            {
                ...
                new RawIndex("dbo", "Burak2", "U_Burak1", 1, "id", 2, true, false, true, false),
                new RawIndex("dbo", "Burak2", "U_Burak1", 2, "num", 2, true, false, true, false),
                ...
                new RawIndex("dbo", "User", "PK_Contacts", 1, "ID", 1, true, true, false, true),
