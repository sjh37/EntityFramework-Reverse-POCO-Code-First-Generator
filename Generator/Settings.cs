...
namespace Efrpg
{
    public static class Settings
    {
        ...
        public static ForeignKeyNamingStrategy ForeignKeyNamingStrategy = ForeignKeyNamingStrategy.Legacy; // Please use Legacy for now (same as versions <= v3.3.0), Latest (not yet ready)
