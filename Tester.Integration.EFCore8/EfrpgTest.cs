...
namespace V8EfrpgTest
{
    ...
    public class V8EfrpgTestDbContextFactory : IDesignTimeDbContextFactory<V8EfrpgTestDbContext>
    {
        ...
        {
            return options == null
                ? new V8EfrpgTestDbContext()
                : new V8EfrpgTestDbContext(options);
        }
    }
    ...
    public class FakeV8EfrpgTestDbContext : IV8EfrpgTestDbContext
    {
        ...
        public DbSet<TEntity> Set<TEntity>() where TEntity : class
        {
            ...
            if (property == null)
                throw new InvalidOperationException("Cannot find a DbSet<" + typeof(TEntity).Name + "> on FakeV8EfrpgTestDbContext. The entity type is not part of this context.");
        ...
        {
            return "FakeV8EfrpgTestDbContext";
        }
