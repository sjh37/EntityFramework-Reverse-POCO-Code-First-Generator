...
namespace V8_Efrpg_Test
{
    ...
    public class Customer
    {
        ...
        public string BillingAddress_Street { get; set; } = null!; // BillingAddress_Street (length: 100)
        public string BillingAddress_City { get; set; } = null!; // BillingAddress_City (length: 50)
        public string BillingAddress_Postcode { get; set; } = null!; // BillingAddress_Postcode (length: 10)
        public string ShippingAddress_Street { get; set; } = null!; // ShippingAddress_Street (length: 100)
        public string ShippingAddress_City { get; set; } = null!; // ShippingAddress_City (length: 50)
    ...
    public class Invoice
    {
        ...
        public string TotalAmount_Currency { get; set; } = null!; // TotalAmount_Currency (length: 3)
    }
