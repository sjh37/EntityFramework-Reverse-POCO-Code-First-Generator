...
namespace V8_Efrpg_Test
{
    ...
    public class V8_Efrpg_Test_Db_Context : DbContext, IV8_Efrpg_Test_Db_Context
    {
        ...
        public V8_Efrpg_Test_Db_Context(DbContextOptions<V8_Efrpg_Test_Db_Context> options)
            : base(options)
        {
        }

        protected V8_Efrpg_Test_Db_Context(DbContextOptions options)
            : base(options)
        {
        }
    ...
    public class Customer
    {
        ...
        public string BillingAddress_Street { get; set; } // BillingAddress_Street (length: 100)
        public string BillingAddress_City { get; set; } // BillingAddress_City (length: 50)
        public string BillingAddress_Postcode { get; set; } // BillingAddress_Postcode (length: 10)
        public string ShippingAddress_Street { get; set; } // ShippingAddress_Street (length: 100)
        public string ShippingAddress_City { get; set; } // ShippingAddress_City (length: 50)
        public string ShippingAddress_Postcode { get; set; } // ShippingAddress_Postcode (length: 10)
    }
    ...
    public class Invoice
    {
        ...
        public decimal TotalAmount_Value { get; set; } // TotalAmount_Value
        public string TotalAmount_Currency { get; set; } // TotalAmount_Currency (length: 3)
    }
    ...
    public class CustomerConfiguration : IEntityTypeConfiguration<Customer>
    {
        public void Configure(EntityTypeBuilder<Customer> builder)
        {
            ...
            builder.Property(x => x.BillingAddress_Street).HasColumnName(@"BillingAddress_Street").HasColumnType("nvarchar(100)").IsRequired().HasMaxLength(100);
            builder.Property(x => x.BillingAddress_City).HasColumnName(@"BillingAddress_City").HasColumnType("nvarchar(50)").IsRequired().HasMaxLength(50);
            builder.Property(x => x.BillingAddress_Postcode).HasColumnName(@"BillingAddress_Postcode").HasColumnType("nvarchar(10)").IsRequired().HasMaxLength(10);
            builder.Property(x => x.ShippingAddress_Street).HasColumnName(@"ShippingAddress_Street").HasColumnType("nvarchar(100)").IsRequired().HasMaxLength(100);
            builder.Property(x => x.ShippingAddress_City).HasColumnName(@"ShippingAddress_City").HasColumnType("nvarchar(50)").IsRequired().HasMaxLength(50);
            builder.Property(x => x.ShippingAddress_Postcode).HasColumnName(@"ShippingAddress_Postcode").HasColumnType("nvarchar(10)").IsRequired(false).HasMaxLength(10);
        }
    }
    ...
    public class InvoiceConfiguration : IEntityTypeConfiguration<Invoice>
    {
        public void Configure(EntityTypeBuilder<Invoice> builder)
        {
            ...
            builder.Property(x => x.TotalAmount_Value).HasColumnName(@"TotalAmount_Value").HasColumnType("decimal(18,2)").HasPrecision(18,2).IsRequired();
            builder.Property(x => x.TotalAmount_Currency).HasColumnName(@"TotalAmount_Currency").HasColumnType("char(3)").HasConversion(new ValueConverter<string, string>(v => v.TrimEnd(), v => v.TrimEnd())).IsRequired().IsFixedLength().IsUnicode(false).HasMaxLength(3);
        }
    }
