...
namespace TestDatabaseDataAnnotation
{
    ...
    {
        [DatabaseGenerated(DatabaseGeneratedOption.None)]
        [Column(@"enum_name", Order = 1, TypeName = "varchar")]
        [Required(AllowEmptyStrings = true)]
        [MaxLength(50)]
        [StringLength(50)]
        [Key]
    ...
    {
        [DatabaseGenerated(DatabaseGeneratedOption.None)]
        [Column(@"TypeName", Order = 1, TypeName = "varchar")]
        [Required(AllowEmptyStrings = true)]
        [MaxLength(50)]
        [StringLength(50)]
        [Key]
        ...
        [DatabaseGenerated(DatabaseGeneratedOption.None)]
        [Column(@"TypeId", Order = 2, TypeName = "int")]
        [Required]
        [Key]
    ...
    public class EnumsWithStringAsValueConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<EnumsWithStringAsValue>
    {
        ...
        {
            Property(x => x.EnumName).IsUnicode(false);
            Property(x => x.Value).IsUnicode(false);
        }
    }
    ...
    public class EnumTest_DaysOfWeekConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<EnumTest_DaysOfWeek>
    {
        ...
        {
            Property(x => x.TypeName).IsUnicode(false);
        }
    }
