        ...
        public Tables LoadTables()
        {
            ...
            try
            {
                using (DbConnection conn = factory.CreateConnection())
                {
                    ...
                    var tables = reader.ReadSchema(TableFilterExclude, UseCamelCase, PrependSchemaName, IncludeComments, IncludeExtendedPropertyComments, TableRename, SchemaName);
...
ORDER BY FK.TABLE_NAME,
        ...
        public class Table
        {
            ...
            {{
                ...
                m.MapLeftKey(""{3}"");
                m.MapRightKey(""{4}"");
            }});", rightTableHumanCase, leftTableHumanCase, left.FkTableName, left.FkColumn, right.FkColumn, prependSchemaName ? ", schema" : ""));
            }
