...
namespace V10EfrpgTestDataAnnotations
{
    ...
    #nullable enable annotations
    public partial class V10EfrpgTestDataAnnotationsDbContext : DbContext, IV10EfrpgTestDataAnnotationsDbContext
    {
        public V10EfrpgTestDataAnnotationsDbContext()
        {
            InitializePartial();
        }

        public V10EfrpgTestDataAnnotationsDbContext(DbContextOptions<V10EfrpgTestDataAnnotationsDbContext> options)
            : base(options)
        {
            InitializePartial();
        }
    ...
    #nullable enable annotations
    public partial class V10EfrpgTestDataAnnotationsDbContextFactory : IDesignTimeDbContextFactory<V10EfrpgTestDataAnnotationsDbContext>
    {
        private readonly DbContextOptions<V10EfrpgTestDataAnnotationsDbContext>? Options;

        public V10EfrpgTestDataAnnotationsDbContextFactory()
        {
            Options = null;
        }

        public V10EfrpgTestDataAnnotationsDbContextFactory(DbContextOptions<V10EfrpgTestDataAnnotationsDbContext> options)
        {
            Options = options;
        }

        public V10EfrpgTestDataAnnotationsDbContext CreateDbContext(string[] args)
        {
            return new V10EfrpgTestDataAnnotationsDbContext();
        }

        public V10EfrpgTestDataAnnotationsDbContext CreateDbContext()
        {
            return Options != null ? new V10EfrpgTestDataAnnotationsDbContext(Options) : new V10EfrpgTestDataAnnotationsDbContext();
        }

        public V10EfrpgTestDataAnnotationsDbContext CreateDbContext(DbContextOptions<V10EfrpgTestDataAnnotationsDbContext> options)
        {
            return options == null
                ? new V10EfrpgTestDataAnnotationsDbContext()
                : new V10EfrpgTestDataAnnotationsDbContext(options);
        }
    }
    #nullable disable
    ...
    public partial class FakeV10EfrpgTestDataAnnotationsDbContext : IV10EfrpgTestDataAnnotationsDbContext
    {
        ...
        public FakeV10EfrpgTestDataAnnotationsDbContext()
        {
            _database = new FakeDatabaseFacade(new V10EfrpgTestDataAnnotationsDbContext());
        ...
        public DbSet<TEntity> Set<TEntity>() where TEntity : class
        {
            ...
            if (property == null)
                throw new InvalidOperationException("Cannot find a DbSet<" + typeof(TEntity).Name + "> on FakeV10EfrpgTestDataAnnotationsDbContext. The entity type is not part of this context.");
        ...
        {
            return "FakeV10EfrpgTestDataAnnotationsDbContext";
        }
    ...
    public class AbOrdersAbConfiguration : IEntityTypeConfiguration<AbOrdersAb>
    {
        public void Configure(EntityTypeBuilder<AbOrdersAb> builder)
        {
            ...
            builder.Property(x => x.Id).HasColumnName(@"ID").HasColumnType("int").ValueGeneratedOnAdd().UseIdentityColumn();
            builder.Property(x => x.Added).HasColumnName(@"added").HasColumnType("datetime").HasDefaultValueSql(@"getdate()");
        }
    }
    ...
    public class CodeObjectConfiguration : IEntityTypeConfiguration<CodeObject>
    {
        public void Configure(EntityTypeBuilder<CodeObject> builder)
        {
            ...
            builder.Property(x => x.CodeObjectNo).HasColumnName(@"codeObjectNo").HasColumnType("int").HasDefaultValueSql(@"0");
            ...
            builder.Property(x => x.IsObject).HasColumnName(@"isObject").HasColumnType("bit").HasDefaultValueSql(@"0");
    ...
    public class ColumnNameAndTypeConfiguration : IEntityTypeConfiguration<ColumnNameAndType>
    {
        public void Configure(EntityTypeBuilder<ColumnNameAndType> builder)
        {
            ...
            builder.Property(x => x.Description).HasColumnName(@"description").HasColumnType("varchar(20)").HasDefaultValueSql(@"space((0))");
            builder.Property(x => x.SomeDate).HasColumnName(@"someDate").HasColumnType("datetime2").HasDefaultValueSql(@"getdate()");
            builder.Property(x => x.Obs).HasColumnName(@"Obs").HasColumnType("varchar(50)").IsRequired(false).HasDefaultValueSql(@"'[{""k"":""en"",""v"":""""},{""k"":""pt"",""v"":""""}]'");
            builder.Property(x => x.Obs1).HasColumnName(@"Obs1").HasColumnType("varchar(50)").IsRequired(false).HasDefaultValueSql(@"'\'");
            builder.Property(x => x.Obs2).HasColumnName(@"Obs2").HasColumnType("varchar(50)").IsRequired(false).HasDefaultValueSql(@"'\\'");
            builder.Property(x => x.Obs3).HasColumnName(@"Obs3").HasColumnType("varchar(50)").IsRequired(false).HasDefaultValueSql(@"'\\\'");
            ...
            builder.Property(x => x.Afloat).HasColumnName(@"afloat").HasColumnType("float").IsRequired(false).HasDefaultValueSql(@"999.");
    ...
    public class CustomerConfiguration : IEntityTypeConfiguration<Customer>
    {
        public void Configure(EntityTypeBuilder<Customer> builder)
        {
            ...
            builder.Property(x => x.BillingAddressStreet).HasColumnName(@"BillingAddress_Street").HasColumnType("nvarchar(100)");
            builder.Property(x => x.BillingAddressCity).HasColumnName(@"BillingAddress_City").HasColumnType("nvarchar(50)");
            builder.Property(x => x.BillingAddressPostcode).HasColumnName(@"BillingAddress_Postcode").HasColumnType("nvarchar(10)");
            builder.Property(x => x.ShippingAddressStreet).HasColumnName(@"ShippingAddress_Street").HasColumnType("nvarchar(100)");
            builder.Property(x => x.ShippingAddressCity).HasColumnName(@"ShippingAddress_City").HasColumnType("nvarchar(50)");
            builder.Property(x => x.ShippingAddressPostcode).HasColumnName(@"ShippingAddress_Postcode").HasColumnType("nvarchar(10)").IsRequired(false);
        }
    }
    ...
    public class dcg_RovColumnDefinitionConfiguration : IEntityTypeConfiguration<dcg_RovColumnDefinition>
    {
        public void Configure(EntityTypeBuilder<dcg_RovColumnDefinition> builder)
        {
            ...
            builder.Property(x => x.Type).HasColumnName(@"TYPE").HasColumnType("char(2)").HasConversion(new ValueConverter<string, string>(v => v.TrimEnd(), v => v.TrimEnd())).IsRequired(false).IsFixedLength();
        }
    }
    ...
    public class DsOpeConfiguration : IEntityTypeConfiguration<DsOpe>
    {
        public void Configure(EntityTypeBuilder<DsOpe> builder)
        {
            ...
            builder.Property(x => x.Id).HasColumnName(@"ID").HasColumnType("int");
            builder.Property(x => x.DecimalDefault).HasColumnName(@"decimal_default").HasColumnType("decimal(15,2)").HasDefaultValueSql(@"99.99");
            builder.Property(x => x.MyGuid).HasColumnName(@"MyGuid").HasColumnType("uniqueidentifier").HasDefaultValueSql(@"'9B7E1F67-5A81-4277-BC7D-06A3262A5C70'");
    ...
    public class EnumWithDefaultValueConfiguration : IEntityTypeConfiguration<EnumWithDefaultValue>
    {
        public void Configure(EntityTypeBuilder<EnumWithDefaultValue> builder)
        {
            ...
            builder.Property(x => x.Id).HasColumnName(@"Id").HasColumnType("int").ValueGeneratedOnAdd().UseIdentityColumn();
            builder.Property(x => x.SomeEnum).HasColumnName(@"SomeEnum").HasColumnType("int").HasDefaultValueSql(@"1");
        }
    }
    ...
    public class InvoiceConfiguration : IEntityTypeConfiguration<Invoice>
    {
        public void Configure(EntityTypeBuilder<Invoice> builder)
        {
            ...
            builder.Property(x => x.TotalAmountValue).HasColumnName(@"TotalAmount_Value").HasColumnType("decimal(18,2)");
            builder.Property(x => x.TotalAmountCurrency).HasColumnName(@"TotalAmount_Currency").HasColumnType("char(3)").HasConversion(new ValueConverter<string, string>(v => v.TrimEnd(), v => v.TrimEnd())).IsFixedLength();
        }
    }
    ...
    public class SmallDecimalTestConfiguration : IEntityTypeConfiguration<SmallDecimalTest>
    {
        public void Configure(EntityTypeBuilder<SmallDecimalTest> builder)
        {
            ...
            builder.Property(x => x.Id).HasColumnName(@"id").HasColumnType("int");
            builder.Property(x => x.KoeffVed).HasColumnName(@"KoeffVed").HasColumnType("decimal(4,4)").IsRequired(false).HasDefaultValueSql(@"0.5");
        }
    }
    ...
    public class TokenConfiguration : IEntityTypeConfiguration<Token>
    {
        public void Configure(EntityTypeBuilder<Token> builder)
        {
            ...
            builder.Property(x => x.Id).HasColumnName(@"Id").HasColumnType("uniqueidentifier").ValueGeneratedOnAdd().HasDefaultValueSql(@"newsequentialid()");
            builder.Property(x => x.Enabled).HasColumnName(@"Enabled").HasColumnType("bit");
        }
    }
