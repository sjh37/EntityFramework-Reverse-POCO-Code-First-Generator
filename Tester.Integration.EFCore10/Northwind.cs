...
namespace Tester.Integration.EFCore10.Northwind
{
    ...
    public class NorthwindDbContextFactory : IDesignTimeDbContextFactory<NorthwindDbContext>
    {
        ...
        {
            return Options != null ? new NorthwindDbContext(Options) : new NorthwindDbContext();
        }
    ...
    public class FakeNorthwindDbContext : INorthwindDbContext
    {
        ...
        {
            _database = new FakeDatabaseFacade(new NorthwindDbContext());
        ...
        public DbSet<TEntity> Set<TEntity>() where TEntity : class
        {
            ...
            if (property == null)
                throw new InvalidOperationException("Cannot find a DbSet<" + typeof(TEntity).Name + "> on FakeNorthwindDbContext. The entity type is not part of this context.");
