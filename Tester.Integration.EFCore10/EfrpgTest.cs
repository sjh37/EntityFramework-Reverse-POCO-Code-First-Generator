...
public partial class V10EfrpgTestDbContext : DbContext, IV10EfrpgTestDbContext
{
    ...
    public V10EfrpgTestDbContext(DbContextOptions<V10EfrpgTestDbContext> options)
        : base(options)
    {
        InitializePartial();
    }
...
public partial class V10EfrpgTestDbContextFactory : IDesignTimeDbContextFactory<V10EfrpgTestDbContext>
{
    ...
    public V10EfrpgTestDbContextFactory()
    {
        Options = null;
    }

    public V10EfrpgTestDbContextFactory(DbContextOptions<V10EfrpgTestDbContext> options)
    {
        Options = options;
    }

    public V10EfrpgTestDbContext CreateDbContext(string[] args)
    {
        return new V10EfrpgTestDbContext();
    }

    public V10EfrpgTestDbContext CreateDbContext()
    {
        return Options != null ? new V10EfrpgTestDbContext(Options) : new V10EfrpgTestDbContext();
    }

    public V10EfrpgTestDbContext CreateDbContext(DbContextOptions<V10EfrpgTestDbContext> options)
    {
        return options == null
            ? new V10EfrpgTestDbContext()
...
public partial class FakeV10EfrpgTestDbContext : IV10EfrpgTestDbContext
{
    ...
    public FakeV10EfrpgTestDbContext()
    {
        _database = new FakeDatabaseFacade(new V10EfrpgTestDbContext());
    ...
    public DbSet<TEntity> Set<TEntity>() where TEntity : class
    {
        ...
        if (property == null)
            throw new InvalidOperationException("Cannot find a DbSet<" + typeof(TEntity).Name + "> on FakeV10EfrpgTestDbContext. The entity type is not part of this context.");
    ...
    {
        return "FakeV10EfrpgTestDbContext";
    }
...
public class CustomerConfiguration : IEntityTypeConfiguration<Customer>
{
    public void Configure(EntityTypeBuilder<Customer> builder)
    {
        ...
        {
            b.Property(x => x.Street).HasColumnName(@"BillingAddress_Street").HasColumnType("nvarchar(100)").IsRequired().HasMaxLength(100);
            b.Property(x => x.City).HasColumnName(@"BillingAddress_City").HasColumnType("nvarchar(50)").IsRequired().HasMaxLength(50);
            b.Property(x => x.Postcode).HasColumnName(@"BillingAddress_Postcode").HasColumnType("nvarchar(10)").IsRequired().HasMaxLength(10);
        });
        builder.OwnsOne(x => x.ShippingAddress, b =>
        {
            b.Property(x => x.Street).HasColumnName(@"ShippingAddress_Street").HasColumnType("nvarchar(100)").IsRequired().HasMaxLength(100);
            b.Property(x => x.City).HasColumnName(@"ShippingAddress_City").HasColumnType("nvarchar(50)").IsRequired().HasMaxLength(50);
            b.Property(x => x.Postcode).HasColumnName(@"ShippingAddress_Postcode").HasColumnType("nvarchar(10)").IsRequired(false).HasMaxLength(10);
        });
    }
}
...
public class InvoiceConfiguration : IEntityTypeConfiguration<Invoice>
{
    public void Configure(EntityTypeBuilder<Invoice> builder)
    {
        ...
        {
            b.Property(x => x.Value).HasColumnName(@"TotalAmount_Value").HasColumnType("decimal(18,2)").HasPrecision(18,2).IsRequired();
            b.Property(x => x.Currency).HasColumnName(@"TotalAmount_Currency").HasColumnType("char(3)").HasConversion(new ValueConverter<string, string>(v => v.TrimEnd(), v => v.TrimEnd())).IsRequired().IsFixedLength().IsUnicode(false).HasMaxLength(3);
        });
    }
}
