...
{
    public class V6EfrpgTestDbContext : DbContext, IV6EfrpgTestDbContext
    {
        public V6EfrpgTestDbContext()
        {
        }

        public V6EfrpgTestDbContext(DbContextOptions<V6EfrpgTestDbContext> options)
            : base(options)
        {
        }
