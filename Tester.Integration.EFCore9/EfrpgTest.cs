...
namespace V9EfrpgTest
{
    ...
    public interface IV9EfrpgTestDbContext : IDisposable
    {
        DbSet<A> A { get; set; } // A
    ...
    public partial class V9EfrpgTestDbContext : DbContext, IV9EfrpgTestDbContext
    {
        ...
        protected V9EfrpgTestDbContext(DbContextOptions options)
            : base(options)
        {
            InitializePartial();
        }
    ...
    public partial class FakeV9EfrpgTestDbContext : IV9EfrpgTestDbContext
    {
        ...
        public FakeV9EfrpgTestDbContext()
        {
            _database = new FakeDatabaseFacade(new V9EfrpgTestDbContext());
        ...
        public DbSet<TEntity> Set<TEntity>() where TEntity : class
        {
            ...
            if (property == null)
                throw new InvalidOperationException("Cannot find a DbSet<" + typeof(TEntity).Name + "> on FakeV9EfrpgTestDbContext. The entity type is not part of this context.");
        ...
        {
            return "FakeV9EfrpgTestDbContext";
        }
    ...
    public enum CarOptions
    {
        ...
        SunRoof = 0x01,
        [Description("Spoiler to add downforce")]
        Spoiler = 0x02,
